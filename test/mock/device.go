...
//NewDevice ...
func NewDevice(_identity string, _syncParam string, _sensors map[string]sensors.ISensor, _channel connInterfaces.IChannel) *Device {
	d := &Device{}
	...
	d.Mutex = &sync.Mutex{}
	d.DeviceProcesses = manager.BuildProcesses(_syncParam)
	return d
}
