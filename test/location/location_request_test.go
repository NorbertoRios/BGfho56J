...
func SetUP() {
	...
	mock.NewDeviceBuilder(message, nil, "12=65.28.9.36.3.4.7.8.11.12.14.17.24.150.56.51.55.70.71.72.73.74.75.76.77.80.81.82", unitofwork.New(mockMysqlRepo, mockRabbitRepo)).Build()
}
